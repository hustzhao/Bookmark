...
- [3. 编程题目](#3-编程题目)
    ...
    - [3.2. 将“引用”作为函数返回值类型的格式、好处和需要遵守的规则?](#32-将引用作为函数返回值类型的格式好处和需要遵守的规则)
    - [3.3. 结构与联合有和区别？](#33-结构与联合有和区别)
    - [3.4. 试写出程序结果：](#34-试写出程序结果)
    - [3.5. 重载（overload)和重写(overried，有的书也叫做“覆盖”）的区别？](#35-重载overload和重写overried有的书也叫做覆盖的区别)
    - [9.有哪几种情况只能用intialization list 而不能用assignment?](#9有哪几种情况只能用intialization-list-而不能用assignment)
    - [3.6. C++是不是类型安全的？](#36-c是不是类型安全的)
    - [3.7. main 函数执行以前，还会执行什么代码？](#37-main-函数执行以前还会执行什么代码)
    - [3.8. 描述内存分配方式以及它们的区别?](#38-描述内存分配方式以及它们的区别)
    - [3.9. 分别写出BOOL,int,float,指针类型的变量a 与“零”的比较语句。](#39-分别写出boolintfloat指针类型的变量a-与零的比较语句)
    - [3.10. 请说出const与#define 相比，有何优点？](#310-请说出const与define-相比有何优点)
    - [3.11. 简述数组与指针的区别？](#311-简述数组与指针的区别)
    - [3.12. int (*s[10])(int) 表示的是什么？](#312-int-s10int-表示的是什么)
    - [3.13. 栈内存与文字常量区](#313-栈内存与文字常量区)
    - [3.14. 将程序跳转到指定内存地址](#314-将程序跳转到指定内存地址)
    - [3.15. int id[sizeof(unsigned long)];这个对吗？为什么？](#315-int-idsizeofunsigned-long这个对吗为什么)
    - [3.16. 引用与指针有什么区别？](#316-引用与指针有什么区别)
    - [3.17. const  与 #define 的比较 ，const有什么优点](#317-const--与-define-的比较-const有什么优点)
    - [3.18. 复杂声明](#318-复杂声明)
    - [3.19. 内存的分配方式有几种](#319-内存的分配方式有几种)
    - [3.20. 基类的析构函数不是虚函数，会带来什么问题？](#320-基类的析构函数不是虚函数会带来什么问题)
    - [3.21. 全局变量和局部变量有什么区别？是怎么实现的？操作系统和编译器是怎么知道的？](#321-全局变量和局部变量有什么区别是怎么实现的操作系统和编译器是怎么知道的)
...
## 3.2. 将“引用”作为函数返回值类型的格式、好处和需要遵守的规则?
...
## 3.5. 重载（overload)和重写(overried，有的书也叫做“覆盖”）的区别？
...
## 3.9. 分别写出BOOL,int,float,指针类型的变量a 与“零”的比较语句。
...
## 3.15. int id[sizeof(unsigned long)];这个对吗？为什么？
...
## 3.17. const  与 #define 的比较 ，const有什么优点
...
## 3.20. 基类的析构函数不是虚函数，会带来什么问题？  

派生类的析构函数用不上，会造成资源的泄漏。

## 3.21. 全局变量和局部变量有什么区别？是怎么实现的？操作系统和编译器是怎么知道的？
